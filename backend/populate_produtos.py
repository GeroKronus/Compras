"""Script para popular banco de dados com produtos de mineradora"""
...
# IDs das categorias
CAT = {
    "discos": 10, "abrasivos": 11, "epis": 12, "quimicos": 13,
    "pecas": 14, "embalagens": 15, "lubrificantes": 16,
    "ferramentas": 4, "insumos": 5
}

produtos = [
    # DISCOS E LAMINAS (cat 10)
    ...
    # ABRASIVOS (cat 11)
    {"codigo": "LIX-AGU-080", "nome": "Lixa DAgua Grao 80", "cat": "abrasivos", "un": "FL", "preco": 3.50, "estoque": 200, "min": 50, "desc": "Lixa d'agua grao 80 para desbaste inicial"},
    {"codigo": "LIX-AGU-120", "nome": "Lixa DAgua Grao 120", "cat": "abrasivos", "un": "FL", "preco": 3.50, "estoque": 200, "min": 50, "desc": "Lixa d'agua grao 120"},
    {"codigo": "LIX-AGU-220", "nome": "Lixa DAgua Grao 220", "cat": "abrasivos", "un": "FL", "preco": 3.80, "estoque": 150, "min": 50, "desc": "Lixa d'agua grao 220 para acabamento"},
    {"codigo": "LIX-AGU-400", "nome": "Lixa DAgua Grao 400", "cat": "abrasivos", "un": "FL", "preco": 4.00, "estoque": 150, "min": 40, "desc": "Lixa d'agua grao 400 para polimento"},
    {"codigo": "LIX-AGU-600", "nome": "Lixa DAgua Grao 600", "cat": "abrasivos", "un": "FL", "preco": 4.20, "estoque": 100, "min": 30, "desc": "Lixa d'agua grao 600 para polimento fino"},
    {"codigo": "LIX-AGU-1200", "nome": "Lixa DAgua Grao 1200", "cat": "abrasivos", "un": "FL", "preco": 4.50, "estoque": 80, "min": 25, "desc": "Lixa d'agua grao 1200 para polimento ultra fino"},
...
for p in produtos:
    ...
    if existing:
        print(f"Produto '{p['codigo']}' ja existe")
        continue
    ...
    novo = Produto(
        ...
        unidade_medida=p["un"],
        preco_referencia=Decimal(str(p["preco"])),
